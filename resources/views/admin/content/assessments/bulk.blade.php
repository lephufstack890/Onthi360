    ...
    <div x-data="{ tab: 'split' }">
        ...
        <div x-show="tab === 'split'" x-cloak
            ...
            <form method="POST" action="{{ route('admin.content.assessments.bulk.split') }}" enctype="multipart/form-data" class="space-y-5">
                ...
                <div class="flex gap-3 pt-2 border-t border-slate-100">
                    <button type="submit" class="inline-flex min-h-11 items-center justify-center gap-1.5 rounded-xl bg-blue-600 px-4 py-2.5 text-[13px] font-bold text-white shadow-sm shadow-blue-200 transition-colors hover:bg-blue-700 shadow-sm hover:bg-blue-700 transition">Tách + Tạo đề</button>
                </div>
            </form>
        </div>
        ...
        <div x-show="tab === 'multi'" x-cloak
            ...
            <form method="POST" action="{{ route('admin.content.assessments.bulk.multi') }}" enctype="multipart/form-data" class="space-y-5">
                ...
                <div class="flex gap-3 pt-2 border-t border-slate-100">
                    <button type="submit" :disabled="items.length === 0" class="inline-flex min-h-11 items-center justify-center gap-1.5 rounded-xl bg-blue-600 px-4 py-2.5 text-[13px] font-bold text-white shadow-sm shadow-blue-200 transition-colors hover:bg-blue-700 shadow-sm hover:bg-blue-700 transition disabled:opacity-50">Tạo <span x-text="items.length"></span> đề</button>
                </div>
            </form>
        </div>
    </div>
