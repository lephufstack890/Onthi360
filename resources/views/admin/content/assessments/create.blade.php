...
@section('content')
    ...
    <x-page-header title="📄 Tạo đề/bộ bài" subtitle="Chỉ tạo thông tin chung của đề — nội dung (câu hỏi rời hoặc PDF + đáp án) hoàn thiện ở màn sau khi lưu." />

    @if ($errors->any())
        @include('partials.toast-flash', ['type' => 'error', 'message' => implode(' ', $errors->all())])
    @endif

    <div class="rounded-lg bg-amber-50 border border-amber-100 p-3 text-xs text-amber-800 mb-4">
