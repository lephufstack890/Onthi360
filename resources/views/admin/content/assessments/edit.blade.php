...
@section('content')
    ...
    @if ($assessment->isPdfMode())
        <div class="rounded-xl border border-sky-200 bg-sky-50 p-4 mb-5 flex items-center justify-between gap-3 flex-wrap">
            ...
            <a href="{{ route('admin.content.assessments.pdf.edit', $assessment->id) }}" class="px-4 py-2 rounded-lg bg-sky-600 text-white text-sm font-medium shadow-sm shrink-0">📄 Quản lý đề PDF ›</a>
        </div>
    @endif
