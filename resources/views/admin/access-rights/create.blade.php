...
@section('content')
    ...
    <x-admin.page-header title="Cấp quyền truy cập" icon="shield-check" subtitle="Cấp trực tiếp — KHÁC với luồng đơn hàng. Chỉ dùng khi có lý do rõ ràng (hỗ trợ, đền bù, tặng...)." />
    ...
    <div class="rounded-3xl border border-sky-100 bg-white shadow-[0_2px_8px_rgba(0,90,180,.04)] p-5 sm:p-6">
        <form method="POST" action="{{ route('admin.access-rights.store') }}" class="space-y-4">
            ...
            <div>
                ...
                <x-admin.select id="user_id" name="user_id" required>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <x-admin.select id="scope" name="scope" required>
