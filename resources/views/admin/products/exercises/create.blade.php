        ...
        <form method="POST" action="{{ route('admin.products.exercises.storeManual', $product->id) }}" class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="lg:col-span-2 bg-white rounded-3xl border border-sky-100 p-5 space-y-4">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        <label class="block text-[13px] font-medium text-slate-600 mb-1" for="code">Mã bài tập</label>
                ...
                <div>
                    <label class="block text-[13px] font-medium text-slate-600 mb-1" for="title">Tên bài tập</label>
            ...
            <div class="bg-white rounded-3xl border border-sky-100 p-5 h-fit space-y-4">
                <h3 class="font-medium text-slate-700 flex items-center gap-2"><span><x-lucide name="target" class="h-4 w-4" /></span> Điểm & phân loại</h3>
                <div>
                ...
                <button type="submit" class="w-full px-4 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-700 transition-colors text-white text-[13px] font-semibold shadow-sm">Lưu bài tập</button>
            </div>
        </form>
    </div>
