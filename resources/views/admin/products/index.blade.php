...
@section('content')
    ...
    <x-ws.page-header title="Tài liệu" icon="wallet-cards" subtitle="Tài liệu là thứ được bán/cấp quyền: sách, chuyên đề, đề thi, khóa học">
        <x-slot:actions>
    ...
    <x-ws.table :columns="['Tên tài liệu', 'Loại', 'Giá', 'Hiển thị', '']">
        @forelse ($products as $p)
            <tr>
                ...
                <td class="px-4 py-3"><x-ws.badge :tone="$p['tone']">{{ $p['visibility'] }}</x-ws.badge></td>
