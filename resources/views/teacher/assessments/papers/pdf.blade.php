                ...
                <div class="flex flex-wrap items-center justify-between gap-3 mb-4">
                    ...
                    <div class="flex flex-wrap items-center gap-2">
                        <a href="{{ route('teacher.papers.answer-keys.template', $assessment->id) }}"
                           class="inline-flex items-center gap-1.5 px-3 py-2 rounded-xl border border-slate-200 text-slate-600 text-sm font-medium hover:border-emerald-300 hover:text-emerald-600 transition">
                            <span>⬇️</span> Tải file Excel mẫu
                        </a>
                        ...
                        <label class="inline-flex items-center gap-2 px-3 py-2 rounded-xl border border-dashed border-slate-300 text-slate-500 text-sm cursor-pointer hover:border-emerald-300 hover:text-emerald-600 transition"
                               x-data="{ name: '' }">
                            <span>📄</span>
                        ...
                        <button type="submit" form="answer-sheet-import"
                                class="inline-flex items-center gap-1.5 px-3 py-2 rounded-xl bg-emerald-600 text-white text-sm font-semibold hover:bg-emerald-700 transition">
