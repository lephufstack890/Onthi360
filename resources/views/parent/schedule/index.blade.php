{{--
  Route: parent.schedule.index
  Spec: 10.3 ("lịch học gần nhất, điểm danh") — mục điều hướng cấp cao trong sidebar phụ
  huynh, không gắn với 1 con cụ thể. App\Http\Controllers\Parent\ScheduleController tự
  chuyển thẳng tới tab "Lịch & Điểm danh" của parent.children.show nếu phụ huynh chỉ có
  đúng 1 con đã xác minh — trang này CHỈ hiện khi có từ 2 con đã xác minh trở lên (chọn con
  trước khi xem lịch/điểm danh chi tiết, tránh trộn dữ liệu nhiều con trên 1 màn — 10.3).
--}}
