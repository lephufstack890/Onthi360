...
@section('content')
    ...
    <div class="bg-gradient-to-br from-amber-50 via-white to-rose-50">
        <div class="max-w-7xl mx-auto px-4 py-12 lg:py-16">
            ...
            <p class="text-slate-500 mt-3 max-w-xl">Mỗi tài liệu nói rõ Công khai/Có phí/Cần kích hoạt ngay trên thẻ — không giấu điều kiện sau nút bấm (12.2). Sách mặc định bản mềm, có thể chọn mua kèm bản in. Tài liệu đã sở hữu có Tic xanh ở ảnh bìa.</p>
        </div>
    </div>
